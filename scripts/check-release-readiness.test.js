...
test('current mini-program passes automated release readiness checks', () => {
  ...
  assert.equal(result.metrics.ugCodedCourseCount, 7253);
  assert.equal(result.metrics.ugProgrammeWithCoursesCount, 104);
  ...
  assert.equal(result.metrics.subpackageBytes.length, 6);
