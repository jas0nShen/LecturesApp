...
test('current mini-program passes automated release readiness checks', () => {
  ...
  assert.equal(result.metrics.tpgProgrammeWithCoursesCount, 160);
  assert.equal(result.metrics.tpgCourseCount, 3738);
  ...
  assert.equal(result.metrics.subpackageBytes.length, 15);
