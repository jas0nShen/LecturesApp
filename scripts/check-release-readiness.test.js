...
test('undergraduate onboarding previews selected school data coverage', () => {
  ...
  assert(onboardingLogic.includes('universityOptions: []'));
  assert(onboardingLogic.includes('programmeOptions: []'));
  assert(onboardingLogic.includes('majorOptions: []'));
  ...
  assert(onboardingPage.includes('range="{{universityOptions}}"'));
...
test('TPG onboarding previews selected school data coverage', () => {
  ...
  assert(onboardingLogic.includes('tpgUniversityOptions: tpgService.listUniversities().map(formatTpgUniversityOption)'));
  ...
  assert(onboardingPage.includes('range="{{tpgUniversityOptions}}"'));
