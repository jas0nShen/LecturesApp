...
const nodeLoaders = {
  ...
  "CUHK": (nodeRequire) => [].concat(nodeRequire("../subpackages/ug-data-cuhk-a/ugCourseData/cuhk-a"), nodeRequire("../subpackages/ug-data-cuhk-b/ugCourseData/cuhk-b")),
...
const packageNames = {
  ...
  "CUHK": [
    "subpackages/ug-data-cuhk-a",
    "subpackages/ug-data-cuhk-b"
  ],
  "EDUHK": [
