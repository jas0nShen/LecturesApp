...
- 本次数据更新：新增 CUHK Hospitality and Real Estate 的 33 门官方明确编码课程，覆盖 Core、Hospitality / Real Estate Stream 与 Summer Internship；未发布固定代码的模块选修和完整完成路径继续保留人工核对边界
